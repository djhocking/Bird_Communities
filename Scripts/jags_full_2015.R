...
sigma.eps.n ~ dunif(0, 10)
      ...
      log(lambda[k]) <- beta0 + eps.n[point[k]] + beta1*VegHgt[point[k]] + beta2*VegHgt[point[k]]*VegHgt[point[k]] + beta3*Shrub_stm_total[point[k]] + beta4*Tree_stm_total[point[k]] # beta0[tran[k]]
