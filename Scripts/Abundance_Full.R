...
vars_full <- c("Point", "ID", "Year", "Visit", "Pyear", "Survey", "Time_bin", "Dist_bin", sp)
...
sim_fit<-jagsUI::jags(data=jags_data,parameters.to.save=params, model.file="jags_full.txt",
